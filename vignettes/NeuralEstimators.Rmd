...
1. Wrap the network in a [`NeuralEstimator`](https://msainsburydale.github.io/NeuralEstimators.jl/dev/API/estimators) corresponding to the intended inferential method, using the R constructors `PointEstimator()`, `PosteriorEstimator()`, or `RatioEstimator()`.
