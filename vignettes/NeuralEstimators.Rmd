...
Once the neural Bayes estimator has been trained, it can be applied to observed data using the function `estimate()`. Below, we use simulated data as a substitute for observed data:
